...
class BloomShaderTransformer {
  ...
  transform(
    ...
    if (!gt_scene.getThreeScene() || !gt_scene.getThreeScene().children.length) {
    ...
    gt_scene.getThreeScene().add(mesh); // Temporarily add to the scene for rendering
    ...
    gt_scene.getThreeScene().remove(mesh); // Remove the temporary mesh
