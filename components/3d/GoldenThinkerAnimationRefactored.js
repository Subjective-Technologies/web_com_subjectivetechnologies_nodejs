...
const GoldenThinkerAnimationRefactored = () => {
  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      new GLTFLoader().load('3d/all.glb', (gltf) => {
        if (!GoldenThinkerAnimationRefactored.model_loaded){
            console.log('model was loaded');
            GoldenThinkerAnimationRefactored.model_loaded = true;              
    ...
    function setupGUI() {
      ...
      animationTextarea.setTextarea(animationTextarea);

      const animationFolder = gui.addFolder('Animation');
      animationFolder.appendChild(animationTextarea);
      ...
      snapshotManager.setTextarea(snapshotTextarea);
...
export default GoldenThinkerAnimationRefactored;
